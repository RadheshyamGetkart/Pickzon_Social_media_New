...
@objc class Themes: NSObject {
    @objc static let sharedInstance = Themes()
   ...
   func removeallSharedObjects(){
    ...
    func saveSharedFilesURLArray(urlArray:Array<String>) {
        print("++++++\(urlArray)")
        UserDefaults(suiteName: "group.NHBQDLLJN4.com.PickZonGroup")?.set(urlArray, forKey: "SharedFilesURLArray")
        UserDefaults(suiteName: "group.NHBQDLLJN4.com.PickZonGroup")?.synchronize()
    }
    
    
    func saveSharedText(text:String) {
        UserDefaults(suiteName: "group.NHBQDLLJN4.com.PickZonGroup")?.set(text, forKey: "sharedText")
        UserDefaults(suiteName: "group.NHBQDLLJN4.com.PickZonGroup")?.synchronize()
    }
