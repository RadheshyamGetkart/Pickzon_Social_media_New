...
//    let newThemeColor = Themes.sharedInstance.colorWithHexString(hex: "#007aff")
    ...
    let txtFdBgColor = Themes.sharedInstance.colorWithHexString(hex: "#EDF0F2")
    

    
    //Themes.sharedInstance.UIColorFromHex(0x19B754) //Themes.sharedInstance.colorWithHexString(hex: "#0000FF")
