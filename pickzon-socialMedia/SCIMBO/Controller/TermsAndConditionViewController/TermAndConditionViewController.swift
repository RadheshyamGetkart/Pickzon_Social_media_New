...
class TermAndConditionViewController: UIViewController {
    ...
    @IBOutlet weak var bottomTxtViewHeightConstraint: NSLayoutConstraint!
var isToHideAgree = false
    override func viewDidLoad() {
        ...
        if isToHideAgree {
            bottomTxtViewHeightConstraint.constant = 0
        }
