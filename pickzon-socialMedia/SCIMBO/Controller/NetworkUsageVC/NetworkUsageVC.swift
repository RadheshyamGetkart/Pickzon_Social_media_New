...
class NetworkUsageVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        headers = ["MESSAGES", "CHAT MEDIA", "TOTAL BYTES"]
        
        Datasource  = ["\(headers[0])" : [["Left" : "Sent", "Right" : "0"], ["Left" : "Received", "Right" : "0"], ["Left" : "Bytes Sent", "Right" : "0 KB"], ["Left" : "Bytes Received", "Right" : "0 KB"]], "\(headers[1])" : [["Left" : "Bytes Sent", "Right" : "0 KB"], ["Left" : "Bytes Received", "Right" : "0 KB"]], "\(headers[2])" : [["Left" : "Sent", "Right" : "0 KB"], ["Left" : "Received", "Right" : "0 KB"]]]
        ...
        DispatchQueue.main.async {
            ...
            self.Datasource  = ["\(self.headers[0])" : [["Left" : "Sent", "Right" : "\(SentChatArr.count)"], ["Left" : "Received", "Right" : "\(ReceivedChatArr.count)"], ["Left" : "Bytes Sent", "Right" : "\(SentDataCount)"], ["Left" : "Bytes Received", "Right" : "\(ReceivedDataCount)"]], "\(self.headers[1])" : [["Left" : "Bytes Sent", "Right" : "\(SentMediaDataCount)"], ["Left" : "Bytes Received", "Right" : "\(ReceivedMediaDataCount)"]], "\(self.headers[2])" : [["Left" : "Sent", "Right" : "\(TotalSentDataCount)"], ["Left" : "Received", "Right" : "\(TotalReceivedDataCount)"]]]
