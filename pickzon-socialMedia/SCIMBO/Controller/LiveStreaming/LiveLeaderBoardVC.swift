...
class LiveLeaderBoardVC: UIViewController {
    ...
    @IBAction func commonHeaderButtonAction(_ sender:UIButton){
        ...
        self.btnLastMonth.setTitleColor(.lightGray, for: .normal)
        self.btnThisMonth.setTitleColor(.lightGray, for: .normal)
    ...
    func getLeaderboardListApi(){
        ...
        let strUrl = Constant.sharedinstance.get_liveleaderboard_data + "?type=\((isLastMonth ? 2 : 1))"
...
extension LiveLeaderBoardVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let cell = tableView.dequeueReusableHeaderFooterView(
            withIdentifier: "LiveParticipantTopTblCell")! as! LiveParticipantTopTblCell
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imgVwGoldBg.isHidden = false
        cell.bgView.layer.borderWidth = 0.0
        cell.btnPIckzonId.setTitleColor(.black, for: .normal)
        cell.lblCoinCount.textColor = .black
