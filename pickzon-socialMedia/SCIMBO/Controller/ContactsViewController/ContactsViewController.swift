...
protocol contactShare : AnyObject {
    func share(rec:NSMutableArray)
    func setBool(view:Bool)
}

class ContactsViewController:  UIViewController,TableViewIndexDelegate,TableViewIndexDataSource,UITableViewDelegate,UITableViewDataSource,UISearchControllerDelegate, UISearchResultsUpdating,CNContactViewControllerDelegate,UISearchBarDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if searchActive == true{
            ...
            cell.status_Lbl.text = "" //setStatusTxt(currentSearchArray.id)
        ...
        cell.status_Lbl.text = "" //setStatusTxt(getFilterVal.id)
        cell.status_Lbl.isHidden = cell.status_Lbl.text == "" ? true : false
