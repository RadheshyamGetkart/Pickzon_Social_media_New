...
public protocol NSVTabAnimationOptions: AnyObject {
...
public protocol NSVAnimatedTabOptions: AnyObject {
    /// Tab bar height
...
public protocol NSVTabItemOptions: AnyObject {
    /// Tab bar item title
    ...
    var badgeString:String?{set get}
}
/// NSVTabController tab bar center item options
public protocol NSVCenterItemOptions: AnyObject {
    /// Center item insets
...
public protocol NSCenterItemSubOptions: AnyObject {
    var image: UIImage {set get}
    var backgroundColor: UIColor {set get}
    var cornerRadius: CGFloat {set get}
    var shadowInfo: ShadowInfo? {set get}
