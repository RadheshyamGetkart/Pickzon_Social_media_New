...
class AnimatedTab: UIView {
     ...
     let containerView = BackgroundStackView(frame: .zero)
     var options: NSVAnimatedTabOptions?
...
//        self.options?.centerItemOptions.size = .init(width: 35, height: 35)
//        self.options?.centerItemOptions.subOptionsSize = .init(width: 25, height: 25)
//        self.options?.centerItemOptions.cornerRadius = 17.5
//    }
//    
//    func updateSizeToSize(){
//        self.options?.centerItemOptions.size = .init(width: 60, height: 60)
//        self.options?.centerItemOptions.subOptionsSize = .init(width: 50, height: 50)
//        self.options?.centerItemOptions.cornerRadius = 30
//    }
