...
class YPFiltersView: UIView {
    ...
    convenience init() {
        ...
        //Custom Crop Button
        customCropButton.setBackgroundImage(YPConfig.icons.cropImage, for: .normal)
        sv(customCropButton)
        customCropButton.size(35)
        |-15-customCropButton
        customCropButton.Bottom == self.Top  + 40
      //  customCropButton.bringSubviewToFront(collectionView)
