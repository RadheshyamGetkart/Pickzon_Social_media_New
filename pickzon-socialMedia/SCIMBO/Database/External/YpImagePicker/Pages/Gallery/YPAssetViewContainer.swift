...
final class YPAssetViewContainer: UIView {
    ...
    public let customCropButton = UIButton()
    ...
    init(frame: CGRect, zoomableView: YPAssetZoomableView) {
        ...
        //Custom Crop Button
//        customCropButton.setImage(YPConfig.icons.loopIcon, for: .normal)
//        sv(customCropButton)
//        customCropButton.size(42)
//        |-15-customCropButton
//        customCropButton.Bottom == self.Bottom - 65
    }
    ...
    @objc public func customCropButtonTapped() {
...
//        (AppDelegate.sharedInstance.navigationController?.topViewController)!.pushView(cropViewController, animated: true)
