...
{
    _edit_toolBar.backgroundColor = color;
}
...
- (void)configCustomNaviBar
{
    ...
    _edit_naviBar.backgroundColor = self.headerBackColor;
    ...
    lbl_title.frame = CGRectMake(0, 0, naviBar.frame.size.width, naviBar.frame.size.height);
    lbl_title.text = self.headerTitle;
    lbl_title.textColor = self.titleTextColor;
    lbl_title.textAlignment = NSTextAlignmentCenter;
    lbl_title.font = self.hedaderFont;
    [naviBar addSubview:lbl_title];
...
- (void)configBottomToolBar
{
    ...
    [_edit_toolBar setMenuBackColor:self.menuBackColor];
