...
extension UITableView{
    func registerCell(){
        ...
        register(UINib(nibName: "ReciveStoryChatTableViewCell", bundle: nil), forCellReuseIdentifier: "incomingStoryChatTblCell")
        register(UINib(nibName: "StoryChatTableViewCell", bundle: nil), forCellReuseIdentifier: "outgoingStoryChatTblCell")
    }
}
