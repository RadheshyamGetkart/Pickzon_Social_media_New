...
final class LocationHelper: NSObject {
    ...
    func getReverseGeoCodedLocationUpdated(location:CLLocation,completionHandler:@escaping ReverseGeoLocationClosure) {
        self.geoLocationCompletionHandler = nil
        self.geoLocationCompletionHandler = completionHandler
        self.reverseGeoCoding(location: location)
    }
...
struct LocationAddress{
    ...
    init(_ address: String = "", _ state: String = "", _ city: String = "", _ country: String = "", _ pincode: String = "", _ longitude: String = "", _ latitude: String = "", _ countryCode: String = ""){
