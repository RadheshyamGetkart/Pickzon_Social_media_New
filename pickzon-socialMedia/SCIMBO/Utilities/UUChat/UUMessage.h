...
@property (nonatomic, copy) NSString*  isForwarded;
...
@property (nonatomic, strong) ReplyInfo* replyObj;
@property (nonatomic, strong) NSString* replyMsgId;

@property (nonatomic, strong) NSString* storyPayload;
