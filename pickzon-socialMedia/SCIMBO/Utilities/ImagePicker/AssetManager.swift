...
open class AssetManager {
  ...
  public static func fetch(withConfiguration config: MyConfiguration, _ completion: @escaping (_ assets: [PHAsset]) -> Void) {
    ...
    DispatchQueue.global(qos: .background).async {
      ...
      let fetchResult = config.allowVideoSelection
