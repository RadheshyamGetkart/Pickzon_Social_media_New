...
class CameraView: UIViewController, CLLocationManagerDelegate, CameraManDelegate {
    ...
    lazy var noCameraLabel: UILabel = { [unowned self] in
        let label = UILabel()
        label.font = self.myConfig.noCameraFont
        label.textColor = self.myConfig.noCameraColor
        label.text = self.myConfig.noCameraTitle
        label.sizeToFit()
    ...
    lazy var noCameraButton: UIButton = { [unowned self] in
        ...
        let title = NSAttributedString(string: self.myConfig.settingsTitle,
                                       attributes: [
                                        NSAttributedString.Key.font: self.myConfig.settingsFont,
                                        NSAttributedString.Key.foregroundColor: self.myConfig.settingsColor
            ])
        ...
        button.layer.borderColor = self.myConfig.settingsColor.cgColor
    ...
    func setupPreviewLayer() {
        ...
        layer.backgroundColor = myConfig.mainColor.cgColor
