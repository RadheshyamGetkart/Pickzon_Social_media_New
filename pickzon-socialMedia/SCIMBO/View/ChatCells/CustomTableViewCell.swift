...
class CustomTableViewCell:UITableViewCell{
    ...
    public var group = Bool(){
        didSet{
            ...
            if messageFrame.message.isForwarded == "1" || messageFrame.message.isForwarded == "2"{
                senderNameLabel?.isHidden = false
                senderNameLabelHeight?.constant = 25
                senderNameLabel?.text = "➦ forwarded"
                senderNameLabel?.textColor = .darkGray
            }
